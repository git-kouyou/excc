...
\section{プログラム}
\subsection{課題3-1}
\lstinputlisting[caption = file-counter.c]{../kadai3/file-counter.c}
\subsection{課題3-2-1}
\lstinputlisting[caption = two-way-pipe.c]{../kadai3/two-way-pipe.c}
\subsection{課題3-2-2}
\lstinputlisting[caption = mergesort.c]{../kadai3/mergesort.c}
\subsection{課題3-3-1}
\lstinputlisting[caption = alarm.c]{../kadai3/alarm.c}
\subsection{課題3-3-2}
\lstinputlisting[caption = simple-talk-client.c]{../kadai3/simple-talk-client.c}
\subsection{発展課題1}
\lstinputlisting[caption = barrier\_sync.c]{../kadai3/barrier_sync.c}
\subsection{発展課題3}
\lstinputlisting[caption = mutual\_exec.c]{../kadai3/mutual_exec.c}
